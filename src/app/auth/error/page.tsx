  ...
  return (
    <div className="bg-[#13151c] border border-red-500/30 rounded-lg p-10 max-w-md w-full text-center shadow-2xl">
      ...
      <div className="flex gap-4 justify-center">
        <Link href="/login" className="bg-amber-500 hover:bg-amber-400 text-gray-950 font-bold py-3 px-6 rounded-md transition-all">
          Coba Login Lagi
        </Link>
        <Link href="/" className="border border-gray-600 hover:border-amber-500 text-gray-300 hover:text-amber-400 font-semibold py-3 px-6 rounded-md transition-all">
          Ke Beranda
        </Link>
      </div>
    </div>
...
export default function AuthErrorPage() {
  return (
    <main className="bg-[#0b0c10] min-h-screen flex items-center justify-center px-4">
      <Suspense fallback={
        <div className="text-amber-400 animate-pulse">Memuat...</div>
      }>
        <ErrorContent />
      </Suspense>
    </main>
